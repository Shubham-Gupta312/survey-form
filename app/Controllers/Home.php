...
class Home extends BaseController
{
    ...
    public function SuperAdminfetchData()
    {
        try {
            ...
            $totalFilterRecords = (!empty($searchValue)) ? $fd->where('emp_id', $searchValue)->countAllResults() : $totalRecords;
            $associativeArray = [];
            ...
            foreach ($data['data'] as $row) {
                ...
                $associativeArray[] = array(
                    ...
                    <button class="btn btn-outline-primary" id="eform"><i class="far fa-edit"></i></button>
