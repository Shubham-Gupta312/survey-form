                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal mt-3 form-material" action="index.html">
                                ...
                                <div class="form-group mb-3">
                                    <div class="col-xs-12">
                                        <input class="form-control" type="password" required="" name="cpassword" name="cpassword" placeholder="Confirm Password">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-0 mt-2 ">
                                    <div class="col-sm-12 text-center ">
                                        Already have an account? <a href="authentication-login1.html " class="text-info ml-1 ">Sign In</a>
                                    </div>
                                </div>
                            </form>
                        </div>
